...
namespace ProjectsManager
{
    public partial class ViewForm : Form
    {
        ...
        {
            MessageBox.Show("Ця форма передбачає введення параметрів динамічного запиту. В ліві колонці відображається назва переметра, в правій - його значення. Після задання параметрів натиснуть кнопку Виконати.");
        }
